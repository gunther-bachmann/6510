...
(define atom-functions '(+ - display cdr car quote cons > < eq? not zero? identity))
...
(define/contract (mil-f-and expr ctxs)
...
(define/contract (mil-f-or expr ctxs)
...
(define/contract (mil-f-if expr ctxs)
...
(define/contract (mil-f-list expr ctxs)
