...
** memory layout
- 0000-00ff ZP
  - PTR for strings/symbols
  - PTR to TOS of Expression Stack
  - PTR to next free cons-cell
  - HIGH-BYTE of to last free cons-cell (reaching this means, the heap needs to allocate new cons cells), done in 256 byte steps
