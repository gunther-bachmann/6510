...
* open tasks
** TODO find a way to know what routines are available
** TODO find a way of how to import the right symbol to have access to this routine!
- e.g. use PUSH_XA_TO_EVLSTKSTK to make use of PUSH_INT_m1_TO_EVLSTK
** TODO find a documentation that allows for easy composition of functions
