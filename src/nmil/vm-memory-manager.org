...
** TODO use new array functions for array access, and provide bc functions optimized for them
- new
  - ALLOC_CELLARR_TO_RA
  - FREE_CELLARR_RZ
...
- optimizing bc functions
  - load array pointers into RA/B/C
  - access array through these pointers instead of repeatedly pushing the array ptr onto the stack
  - old
    - BC_XET_ARRAY_FIELD (GET_AF_n, SET_AF_n)
  - new
    - GET_Rx_AF_n, SET_Rx_AF_n
    - BC_POP_TO_Rx (pop tos into ra/b/c)
