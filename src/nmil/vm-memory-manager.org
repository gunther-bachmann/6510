...
| NEW_DEC_REFCNT_RC                                | i               | generic dec refcnt rc, calls more specific routines once the ptr type was detected                                                                                           |
|--------------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|--------------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NEW_FREE_CELLPAIR_RT                             | i               | prefix new_free_cellpair_rc with copy rt->rc                                                                                                                                 |
| NEW_FREE_CELLPAIR_RA                             | i               | prefix new_free_cellpair_rc with copy ra->rc                                                                                                                                 |
| NEW_FREE_CELLPAIR_RC                             | i               | specific free for cellpair ptr                                                                                                                                               |
|--------------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|--------------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NEW_FREE_CELL_RT                                 | i               | prefix new_free_cell_rc with copy rt->rc                                                                                                                                     |
| NEW_FREE_CELL_RA                                 | i               | prefix new_free_cell_rc with copy ra->rc                                                                                                                                     |
| NEW_FREE_CELL_RC                                 | i               | generic, call specific routines once cell type is detected                                                                                                                   |
|--------------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
** IMPLEMENT labels in debugger
- [X] add all labels to the debugger
- [X] list labels (with addresses) matching regex
- [X] get address for (one) label
- [ ] use labels in place of addresses in all debug commands
  - [ ] set break point at label
* current (en)coding
** naming
 naming: atomic cell
