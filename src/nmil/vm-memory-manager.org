...
* open tasks
** TODO make sure disassembler works for labels with any number of relevant digits
currently in interactive mode, debugger starts at $8xx, which seems not to resolve the labels correctly
