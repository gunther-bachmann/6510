...
- translation table
  ...
  | x    | VM_ALLOC_PAGE_FOR_M1_SLOTS                  | INIT_M1Px_PAGE_A                 | D    |                                                        |
  ...
  |      | VM_ALLOC_CELL_ON_PAGE                       | ALLOC_CELL_ON_PAGE_A_TO_RT       | D    |                                                        |
  |      | VM_ALLOC_CELL_PAIR_ON_PAGE_A_INTO_RT        | ALLOC_CELLPAIR_ON_PAGE_A_TO_RT   | D    |                                                        |
  |      | VM_ALLOC_CELL_PAIR_PTR_TO_RT                | ALLOC_CELLPAIR_TO_RT             | D    | ensure that RT holds ptr to new cell-pair              |
