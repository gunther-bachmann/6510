...
- translation table
  ...
  | -    | VM_ALLOC_PAGE_FOR_CELL_PAIRS                | INIT_CELLPAIR_PAGE_AX            | D    | INIT_CELLPAIR_PAGE_X_TO_AX                             |
  | x    | INIT_CELLPAIR_PAGE_A                        |                                  | C    | result is returned in X -> refactor to return in A     |
  |      | VM_ALLOC_CELL_STACK_PAGES                   | INIT_CELLSTACK_PAGE_A            | D    | INIT_CELLSTACK_PAGE_X_TO_AX                            |
  | -    | VM_ALLOC_PAGE_FOR_M1_SLOTS                  | INIT_M1Px_PAGE_A                 | D    | INIT_M1Px_PAGE_X_TO_AX                                 |
  |------+---------------------------------------------+----------------------------------+------+--------------------------------------------------------|
  |      | alloc/free cells, pairs, slots              |                                  |      |                                                        |
  |------+---------------------------------------------+----------------------------------+------+--------------------------------------------------------|
  | -    |                                             | GET_PAGE_FOR_ALLOC_CELL_TO_A     |      | GET_PAGE_FOR_ALLOC_CELL_TO_X?                          |
