...
- translation table
  ...
  |      | alloc/free pages                            |                                  |                                                        |
  |------+---------------------------------------------+----------------------------------+--------------------------------------------------------|
  |      | VM_FREE_PAGE                                | FREE_PAGE_A                      |                                                        |
  |      | VM_ALLOC_PAGE__PAGE_UNINIT                  | ALLOC_PAGE_TO_A                  |                                                        |
  |      | VM_ALLOC_PAGE_FOR_CELLS                     | INIT_CELL_PAGE_A                 | ALLOC_PAGE_TO_A + INIT_CELL_PAGE_A                     |
  |      | VM_ALLOC_PAGE_FOR_CELL_PAIRS                | INIT_CELLPAIR_PAGE_A             |                                                        |
  |      | VM_ALLOC_CELL_STACK_PAGES                   | INIT_CELLSTACK_PAGE_A            |                                                        |
