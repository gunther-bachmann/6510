...
* system bytecodes/functions
- create/delete/update file
- read/write files/streams
- read/write memory regions
- read/write memory byte
- flip/set/clear bits (with disabled/enabled interrupts)
see https://www.pagetable.com/c64ref/kernal,
and https://c64os.com/c64os/programmersguide/usingkernal_file#mod_file_fopen
and http://www.6502.org/users/andre/lib6502/lib6502.html#dir
