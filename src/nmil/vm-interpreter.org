...
|   00 | -                 | BNOP              | BRK               | SWAP              | EXT               | PUSH_B            | PUSH_I             | INT_P             | -                      | PUSH_NIL   | CONS_PAIR_P            | TRUE?_RET   | TRUE?_BRANCH           | FALSE?_BRANCH | FALSE?_RET             | DUP |
|   10 | -                 | POP               | CELL_EQ?          | FALSE?_RET_FALSE  | ALLOC_ARRAY       | PUSH_ARRAY_FIELD  | POP_TO_ARRAY_FIELD | PUSH_B            | -                      |            |                        |             |                        |               |                        |     |
|   20 | -                 | NIL?              | INT=0?            |                   |                   |                   |                    |                   | -                      | NATIVE     |                        |             |                        |               |                        |     |
