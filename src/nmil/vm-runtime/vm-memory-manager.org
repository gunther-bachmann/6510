...
INC_REFCNT_RT (vm-memory-manager.rkt)
  => INC_REFCNT_M1_SLOT_RT_N (vm-m1-slots-n.rkt)
ALLOC_CELLARR_TO_RA (vm-cell-array.rkt)
  => ALLOC_CELL_ARRAY_TO_RA (vm_cell-array-n.rkt)
DEC_REFCNT_RT (vm-memory-manager.rkt)
  => DEC_REFCNT_M1_SLOT_RT_N (vm-m1-slots-n.rkt)
DEC_REFCNT_RZ (vm-memory-manager.rkt)
  => DEC_REFCNT_M1_SLOT_RZ_N (vm-m1-slots-n.rkt)
* open tasks
