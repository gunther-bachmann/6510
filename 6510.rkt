...
(require "6510.logic-ops.rkt")
(require "6510.branch-ops.rkt")
(require "6510.arithmetic-ops.rkt")
(require "6510.increment-ops.rkt")
(require "6510.flag-ops.rkt")
(require "6510.memory-ops.rkt")
(require "6510.transfer-ops.rkt")
(require "6510.shift-ops.rkt")
(require "6510.misc-ops.rkt")
(require "6510.compare-ops.rkt")
(require "6510.subroutine-ops.rkt")
(require "6510.stack-ops.rkt")

(provide (all-from-out "6510-command.rkt"))

(provide (all-from-out "6510.logic-ops.rkt"))
(provide (all-from-out "6510.branch-ops.rkt"))
(provide (all-from-out "6510.arithmetic-ops.rkt"))
(provide (all-from-out "6510.increment-ops.rkt"))
(provide (all-from-out "6510.flag-ops.rkt"))
(provide (all-from-out "6510.memory-ops.rkt"))
(provide (all-from-out "6510.transfer-ops.rkt"))
(provide (all-from-out "6510.shift-ops.rkt"))
(provide (all-from-out "6510.misc-ops.rkt"))
(provide (all-from-out "6510.compare-ops.rkt"))
