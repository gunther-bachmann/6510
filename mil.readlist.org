...
- registers-usage :: description of the register use (e.g. vm_​l0 r/w, vm_​p1 r)
  this information (of the dataflow) is used for instruction reordering
  it can be used to find out which register are free for allocation for other instructions
