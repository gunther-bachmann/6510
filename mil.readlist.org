...
- [ ] implement tree algorithm
  ...
  - n-ary tree of integers
    (useful for what?)
    node: car = (ptr = level-down | value)
          cdr = ptr to sibling | NIL <- n-arry tree allows for n siblings (same level)
          binary tree:   1        ---- level_0
          maps to: (l_0 1 . NIL )
          in list notation: (l_0 1)

          binary tree:   o        ---- level_0
                        / \
                       1   2      ---- level_1
          maps to: (l_0 (l_1 1 . (l_1 2 . NIL ) ) . NIL )
          in list notation: (l_0 (l_1 1 2))
          ...
          binary tree:     o      ---- level_0
                        ...
                        / \
                       1   2      ---- level_2
          maps to: (l_0 (l_1 (l_2 1 . (l_2 2 . NIL ) ) . (l_1 (l_2 3 . NIL ) . NIL ) ) . NIL )
          in list notation: (l_0 (l_1 (l_2 1 2 ) (l_1 (l_2 3 ))))

          binary tree:   o        ---- level_0       [ . NIL ]
                        / \                         /   
                       o   o      ---- level_1     [ . ]----------->[ . NIL ]   
                      /|   |\                     /                /
                     1 2   o 5    ---- level_2   [1.]->[2.NIL]    [ . ]->[5.NIL]
                          / \                                    /
                         3   4    ---- Level_3                  [3.]-->[4.NIL]
          maps to: (l_0 (l_1 (l_2 1 . (l_2 2 . NIL ) ) . (l_1 (l_2 (l_3 3 . (l_3 4 . NIL ) ) . (l_2 5 . NIL ) ) )) . NIL )
          in list notation: (l_0 (l_1 (l_2 1 2) (l_1 (l_2 (l_3 3 4) 5))))
    - (make-node val) -> node
    ...
    - necessary lisp functions: car, cdr, cons, append <- append can be simplified in case of binary trees!
      (def (append (a list) (b list) list)
           (reverse (reverse a) b))
  - [ ] tree for ordered traversal/find (each node needs data to decide <=, >)
