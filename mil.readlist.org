...
- [ ] optimization idea: no parameter ptr, just cell-stack
  ...
  - other parameter order
    ...
    pop to local#0         ;; b-list
    write to local#1       ;; a-list
    nil? return local#0    ;; a-list
    cdr                    ;; new-a-list
  ...
  - check out other functions to check validity of this optimization
    ...
    - function 3:
    - function 4:
- [ ] optimizations for call stack/frame
  - [ ] spread low/high over two pages
  ...
  - [ ] allow fast call frames (less copying, less space consumption)
