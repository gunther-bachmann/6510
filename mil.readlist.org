...
* references (phind)
- https://github.com/SvenMichaelKlose/tunix/blob/main/src/bin/lisp/doc/manual.md
- https://dercuano.github.io/notes/tiny-interpreters-for-microcontrollers.html
- https://dwheeler.com/6502/#plasma
- https://www.lemon64.com/forum/viewtopic.php?t=55465&sid=4c129dfc21d6f951f7e046f42187beb0&start=15
  #+begin_src asm
    	; Stacker mk. 2
    	; "The Fast Version"
...
**** IMPLEMENT redesign vm-memory-manager
- identify things that still make the redesign diffficult
...
- incrementing ref count and then doing a destructive NIL? etc. is not necessary either
  example:
  #+begin_src scheme
    (bc WRITE_TO_LOCAL_1)   ;; increment ref count
