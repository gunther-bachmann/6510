...
**** do tracing only on call and ret 
- print function names, too
- print stack on call and result on ret
**** functions allow for metadata (could enhance tracing) and defaults
...
**** call with defaults (related to concept of constants!)
...
- [ ] get rid of refcount​_decr​_rt (only use 'ra')
- [ ] reduce impact/cpu cycles
