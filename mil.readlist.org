...
- [X] implement basic byte code debugger on top of 6510 debugger
  ...
  - [X] step over call
**** TODO implement some code for arrays (structures)
...
**** TODO implement some code for native arrays (strings)
**** TODO implement larger array by using a BST tree of arrays?
**** refcount qualities
